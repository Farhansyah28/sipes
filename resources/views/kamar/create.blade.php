                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('kamar.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('kapasitas') border-red-500 @enderror" id="kapasitas" name="kapasitas" type="number" min="1" value="{{ old('kapasitas') }}" required>
                            @error('kapasitas')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
